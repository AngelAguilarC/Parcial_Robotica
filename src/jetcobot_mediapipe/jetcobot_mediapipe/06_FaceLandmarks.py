...
class FaceLandmarks(Node):
    def __init__(self, dat_file):
        ...
        self.graspController.init_pose2()
...
def main(args=None):
    ...
    dat_file = os.path.join(current_dir_path, "/home/jetson/jetcobot_ws/src/jetcobot_mediapipe/jetcobot_mediapipe/file/shape_predictor_68_face_landmarks.dat")
