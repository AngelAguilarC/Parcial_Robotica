...
class RgbDepthImageNode:
    def __init__(self):
        ...
        self.mc.send_angles([20, 0, -90, 10, 0, -45], 50)
        ...
        info_sub = message_filters.Subscriber('/camera/depth/camera_info', CameraInfo, queue_size=1)
    ...
    def image_proc(self):
        ...
        try:
            ...
            for obj in contours:
                ...
                pose_end = np.matmul(self.hand2cam_tf_matrix, xyz_euler_to_mat(position, (0, 0, 0)))  # 转换的末端相对坐标
